...
for i in company_list:
    ...
    if os.path.exists('../build/%s-价格通知.docx' % i):
        os.remove('../build/%s-价格通知.docx' % i)
    document.save('../build/%s-价格通知.docx' % i)
    # 以“客户名-价格通知”作为文件名保存
    docx_path = '../build/%s-价格通知.docx'% i
    pdf_path = '../build/%s-价格通知.pdf'% i
